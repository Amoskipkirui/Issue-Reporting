...
namespace WARTECHCONNECTION
{
    public class cConnect : IDisposable
    {
        ...
        public cConnect()
        {
            try
            {
                //string datasource = Reg.Read("SERVER ADDRESS");
                //string database = Reg.Read("DATABASE");
                //string userID = Reg.Read("DATABASE USER");
                //string passWord = Reg.Read("DATABASE PASSWORD");

                // this.mConnectionString = "Data Source=./;Initial Catalog=CARDTRACK;Persist Security Info=True";
                //this.mConnectionString = "Data Source=" + datasource + ";Initial Catalog=" + database + ";Persist Security Info=True;User ID=" + userID + "; Password = " + passWord + "";
                //this.mConnectionString = @"Data Source=192.168.220.7/MSSQLSERVER;Initial Catalog=Sacco;Persist Security Info=True;User ID='nicholas'; Password='nicholas'";
                this.mConnectionString = "Data Source=DESKTOP-U60GKLU;Initial Catalog=REGIPAGE;Integrated Security=True";
                //WARREN\SQLEXPRESS
                //SVDCATMRECON01
                //SIGEI-PC\\MS2008
...
* where the error is caught and resolved */
        ...
        internal void AddWithValue(string p, string fileName)
        {
        ...
        internal SQL_KCA.SqlDataAdapter ReadDB3(string p)
        {
            throw new NotImplementedException();
        }
    }//end of cConnect
